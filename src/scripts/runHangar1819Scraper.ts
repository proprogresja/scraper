import { Hangar1819Scraper } from '../scrapers/Hangar1819Scraper'
...
async function runHangar1819Scraper() {
  ...
  const scraper = new Hangar1819Scraper()
  ...
  try {
    ...
    const outputPath = join(__dirname, '..', 'data', 'scrapes', `hangar1819-scrape-${timestamp}.json`)
