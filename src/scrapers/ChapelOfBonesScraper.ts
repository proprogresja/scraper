...
export class ChapelOfBonesScraper extends BaseScraper {
  private readonly tickpickUrl = 'https://www.tickpick.com/organizer/o/chapel-of-bones';
  private readonly location = 'Raleigh, NC';
