...
exports.FillmoreCharlotteScraper = void 0;
const cheerio = __importStar(require("cheerio"));
const BaseScraper_1 = require("./BaseScraper");
const puppeteer_1 = __importDefault(require("puppeteer"));
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
class FillmoreCharlotteScraper extends BaseScraper_1.BaseScraper {
    constructor() {
        const config = {
    ...
    async scrape() {
        ...
        try {
            ...
            await page.screenshot({ path: path_1.default.join(debugDir, 'fillmore-charlotte-screenshot.png'), fullPage: true });
            console.log(`Saved screenshot to ${path_1.default.join(debugDir, 'fillmore-charlotte-screenshot.png')}`);
            // Get the HTML content after JavaScript has rendered
            const content = await page.content();
            fs_1.default.writeFileSync(path_1.default.join(debugDir, 'fillmore-charlotte-rendered.html'), content);
            console.log(`Saved rendered HTML to ${path_1.default.join(debugDir, 'fillmore-charlotte-rendered.html')}`);
    ...
    extractEventsFromGeneralStructure($) {
    ...
    extractDatesFromPageStructure(events, $) {
...
exports.FillmoreCharlotteScraper = FillmoreCharlotteScraper;
